...
public class Matrix3fTest {
    ...
    public void copyTest1() {
        ...
        Matrix3f original = new Matrix3f(elements);
        Matrix3f copy = new Matrix3f(original);
        Assertions.assertArrayEquals(original.getElements(), copy.getElements(), "Копирующий конструктор должен создавать идентичную матрицу");
    }

    @Test
    public void Array2DTest1() {
        float[][] elements = {
                {1, 2, 3},
                {4, 5, 6},
                {7, 8, 9}
        ...
        Matrix3f matrix = new Matrix3f(elements);
        Assertions.assertArrayEquals(elements, matrix.getElements(), "Матрица должна быть создана из переданного двумерного массива");
    }
    ...
    public void getElementTest1() {
        ...
        Matrix3f matrix = new Matrix3f(elements);
        Assertions.assertEquals(5, matrix.getElement(1, 1), "Метод getElement должен возвращать правильный элемент");
    }
    ...
    public void setElementTest1() {
        ...
        Assertions.assertArrayEquals(expected, matrix.getElements(), "Метод setElement должен правильно установить элемент матрицы");
    }

    @Test
    public void addVTest1() {
        float[] elementsA = {
                1, 2, 3,
                4, 5, 6,
                7, 8, 9
        ...
        Assertions.assertArrayEquals(expected, A.getElements(), "Метод addV должен правильно добавить матрицу B к A");
    }


    @Test
    public void addVTest2() {
        float[] elementsA = {
                0, -1, 2,
                3, 4, -5,
                6, -7, 8
    ...
    public void subVTest1() {
        ...
        Assertions.assertArrayEquals(expected, A.getElements(), "Метод subV должен правильно вычесть матрицу B из A");
    }


    @Test
    public void multiplyNewTest1() {
        float[] elementsA = {
                1, 2, 3,
                4, 5, 6,
                7, 8, 9
        ...
        Matrix3f A = new Matrix3f(elementsA);
        Matrix3f B = new Matrix3f(elementsB);
        Matrix3f result = A.multiplyNew(B);
        float[][] expected = {
                {30, 24, 18},
                {84, 69, 54},
                {138, 114, 90}
        };
        Assertions.assertArrayEquals(expected, result.getElements(), "Метод multiplyNew должен корректно умножать матрицы и возвращать новый экземпляр");
        // Проверяем, что исходные матрицы не изменяются
        Assertions.assertNotEquals(result, A, "Исходная матрица A должна остаться неизменной");
        Assertions.assertNotEquals(result, B, "Исходная матрица B должна остаться неизменной");
    }


    @Test
    public void transpositionNewTest1() {
        float[] elements = {
                1, 2, 3,
                4, 5, 6,
                7, 8, 9
        ...
        Matrix3f matrix = new Matrix3f(elements);
        Matrix3f transposed = matrix.transpositionNew();
        float[][] expected = {
                {1, 4, 7},
                {2, 5, 8},
                {3, 6, 9}
        };
        Assertions.assertArrayEquals(expected, transposed.getElements(), "Метод transpositionNew должен корректно транспонировать матрицу и вернуть новый экземпляр");
        // Проверяем, что исходная матрица не изменяется
        float[][] original = {
                {1, 2, 3},
                {4, 5, 6},
                {7, 8, 9}
        };
        Matrix3f orig = new Matrix3f(original);
        Assertions.assertEquals(orig, matrix, "Исходная матрица должна остаться неизменной после транспонирования");
    }
    ...
    public void inverseTest2() {
        ...
        assertMatrixEquals(new Matrix3f(expectedInverseElements), inverse);
    }
    ...
    public void equalsTest2() {
        ...
        Assertions.assertTrue(A.equals(B), "Матрицы должны считаться равными с учетом погрешности");
    }
    ...
    public void equalsTest3() {
        ...
        Assertions.assertFalse(A.equals(C), "Матрицы с разными элементами не должны быть равны");
    }
